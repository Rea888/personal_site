...
<main id="main">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-7">
                    <div class="about-descr">
                        ...
                        <p class="p-heading">Greetings, I am Viki, a spirited Junior PHP Developer specializing in
                            backend
                            development. I am thrilled to introduce myself to you.</p>


                        <p class="separator">Briefly highlighting my technical toolkit, I am skilled in PHP, Laravel,
                            ...
                            Programming, ensuring maintainable and scalable code. Additionally, I am in the process of
                        ...
                        <p class="separator">Before delving into programming, my background as a business manager in a
                        ...
                        <p class="separator">My foray into programming is rooted in passion. Through self-study and
                            small-scale projects, I have built a strong foundation in backend technologies and developed
                            keen problem-solving skills.</p>

                        <p class="separator">As an aspiring Junior PHP Developer, I am eager to bring my combination of
                        ...
                        <p class="separator">Feel free to explore, connect, and reach out if you’re keen to discuss
                            technology, collaboration, or if you're just curious to know more about my journey. I’m here
                    ...
                    <div class="swiper-slide">
                        <div class="services-block">
                            <a href="https://github.com/Rea888"><img src="{{asset('import/assets/img/git.png')}}" alt=""
                                                                     class="img-fluid" height="40" width="40"></a>

                            <span><a href="https://github.com/Rea888">Git</a></span>
                            <p class="separator">Git helps manage my code changes, work with
                                ...
                                it.I invite you to browse through my <a href="https://github.com/Rea888">GitHub</a>
                    ...
                    <div class="swiper-slide">
                        <div class="services-block">
                            <a href="https://github.com/Rea888/Articles"><img
                                    ...
                                    class="img-fluid" height="40" width="40"></a>
                            <a href="https://github.com/Rea888/Articles"><span>PHP</span></a>
                            <p class="separator">I built a foundation in PHP with this <a
                                    href="https://github.com/Rea888/Articles">project</a> by focusing on the core
                    ...
                    <div class="swiper-slide">
                        <div class="services-block">
                            <img src="{{asset('import/assets/img/docker.png')}}" alt=""
                                 class="img-fluid" height="25" width="25">
                            <span>Docker</span>
                            <p class="separator">Docker is an amazing open-source tool. It creates a special environment
                    ...
                    <div class="swiper-slide">
                        <div class="services-block">
                            <a href="https://github.com/Rea888/planetSeeker/blob/master/app/ApiClient/Meteo/AbstractMeteoDataMapper.php"><img
                                    ...
                                    class="img-fluid" height="40" width="40"></a>
                            <a href="https://github.com/Rea888/planetSeeker/blob/master/app/ApiClient/Meteo/AbstractMeteoDataMapper.php"><span>SOLID</span></a>
                            <p class="separator">I follow SOLID principles because they help make code better by using
                                interfaces and <a
                                    href="https://github.com/Rea888/planetSeeker/blob/master/app/ApiClient/Meteo/AbstractMeteoDataMapper.php">abstract
                    ...
                    <div class="swiper-slide">
                        <div class="services-block">
                            <a href="https://github.com/Rea888/planetSeeker/tree/master/app/Service"><img
                                    ...
                                    class="img-fluid" height="40" width="40"></a>
                            <a href="https://github.com/Rea888/planetSeeker/tree/master/app/Service"><span>OOP</span></a>
                            <p class="separator">I find Object-Oriented Programming (OOP) super useful because it allows
                                ...
                                with complicated <a
                                    href="https://github.com/Rea888/planetSeeker/tree/master/app/Service">projects</a>
                                and makes
    ...
    <div id="portfolio" class="paddsection">
        ...
        <div class="container" id="whole">
            <div id="intro">
                <h2 style="color: #d4bd98">Viktoria Rakhely</h2>
                <h3 style="color: #2b0c0b"><b>PHP Developer</b></h3>
                <p style="color: #d4bd98"><font size="+2">I am an enthusiast in software development, with a keen
                        interest in learning and growing within this field. My desire is to leverage this knowledge and
                        actively contribute to the field of software development, using my skills to bring innovative
                        solutions and positively impact the technology community.</font></p>
            </div>
            <div class="section-title text-center" id="contactl">
                <h3 style="color: #a14532">Contacts</h3></div>
                ...
                <div class="row gx-6">
                    ...
                    <div class="col-lg-6">
                        <div class="about-descr" id="cont1">
                            ...
                            <h4 style="color: black"><a href="mailto:info@viktoriarakhely.eu"><img
                                        src="{{asset('import/assets/img/envelope.svg')}}" alt="SVG Image"
                                        style="margin-right: 1%"><b>dev@viktoriarakhely.eu</b></a>
                            </h4>
                            <h4 style="color: black"><img src="{{asset('import/assets/img/location.svg')}}"
                                                          alt="SVG Image"
                                                          style="margin-right: 1%"><b>Trierweiler, Germany</b></h4>
                            <h4 style="color: black"><a href="https://www.linkedin.com/in/viktoriarakhely/"><img
                    ...
                    <div class="col-lg-6">
                        <div class="about-descr" id="cont2">
                            ...
                            <h4 style="color: black"><a href="https://viktoriarakhely.eu/"><img
                                        src="{{asset('import/assets/img/hand.svg')}}" alt="SVG Image"
                                        style="margin-right: 1%"><b>viktoriarakhely.eu</b></a></h4>
                            <h4 style="color: black"><a href="https://github.com/Rea888"><img
            ...
            <div class="contact-block1" id="body">
                <div class="row">

                    <div class="col-lg-6">
                        <div class="about-descr" id="bod1">
                            <h3 id="cvh" style="color: #8d2a1b"><u><b>EDUCATION</b></u></h3>
                            <p style="color: #2b0c0b"><b><b>Udemy Courses</b></b></p>
                            <p style="color: #2b0c0b"><i>2022 - 2023</i></p>

                            <p style="color: #2b0c0b"><u>Dave Hollingworth: PHP for Beginners</u></p>
                            <p style="color: #2b0c0b">-HTML, HTML Forms, Mixing PHP and HTML<br>
                            ...
                            <p style="color: #2b0c0b"><u>Edwin Diaz: PHP with Laravel - Become a Master in Laravel</u>
                            </p>
                            <p style="color: #2b0c0b">-Routes, Controllers<br>
                            ...
                            <p style="color: #2b0c0b"><b><b>Udemy Courses</b></b></p>
                            <p style="color: #2b0c0b"><i>2020 - 2021</i></p>
                            <p style="color: #2b0c0b"><u>The Complete Java Certification Course</u></p>
                            <p style="color: #2b0c0b">-Understanding Object Orientation: Class, Object,<br>
                            ...
                            <p style="color: #2b0c0b"><b><b>Semmelweis University</b></b></p>
                            <p id="cv" style="color: #2b0c0b"><i>2009 - 2011</i></p>
                            <p id="cv" style="color: #2b0c0b">Faculty of Conductive Education</p>

                            <h3 id="cvh" style="color: #8d2a1b"><u><b>SKILLS</b></u></h3>
                            <p><span id="skill">PHP</span>
                                <span id="skill">Laravel</span>
                                <span id="skill">MYSQL</span>
                                <span id="skill">OOP</span>
                                <span id="skill">SOLID</span>
                                <span id="skill">Git</span></p>
                            <p><span id="skill">Java</span>
                                <span id="skill">Docker</span>
                                <span id="skill">Jenkins</span></p>
                            <p><span id="skill">CSS</span>
                                <span id="skill">JavaScript</span>
                                <span id="skill">Bootstrap</span>
                                <span id="skill">AWS</span>
                                <span id="skill">CI/CD</span>
                            </p>

                            <h3 id="cvh" style="color: #8d2a1b"><u>LANGUAGES</u></h3>
                            <p style="color: #2b0c0b">English<br>
                                Full Professional Proficiency</p>
                            <p style="color: #2b0c0b">Hungarian<br>
                                Native or Bilingual Proficiency</p>
                            <p style="color: #2b0c0b">German<br>
                                Limited Working Proficiency</p>

                            <h3 id="cvh" style="color: #8d2a1b"><u><b>PROJECTS</b></u></h3>
                            <p style="color: #2b0c0b"><b><b>Weather Data Analysis System</b></b></p>
                            <p style="color: #2b0c0b">The Weather Data Analysis System is a PHP project developed using
                                ...
                                processing and storage. It leverages the power of MySQL as the database with a database
                    ...
                    <div class="col-lg-6">
                        <div class="about-descr" id="bod2">
                            ...
                            <p style="color: #2b0c0b"><b><b>Personal Site</b></b></p>
                            <p style="color: #2b0c0b">The Personal Site project is a dynamic website built using PHP and
                                the Laravel
                                framework. It incorporates Bootstrap for responsive and visually appealing design. The
                                project is integrated with Jenkins, utilizing a Jenkins pipeline. Whenever changes are
                                merged into the master branch, the pipeline triggers an automated process to rebuild the
                                project and deploy it onto the server. This ensures a seamless and efficient workflow,
                            ...
                            <p style="color: #2b0c0b"><b><b>Christmas escape room</b></b></p>
                            <p style="color: #2b0c0b">The Christmas-themed activity, inspired by the renowned Cicada3301
                                event, offers
                                participants
                            ...
                            <p style="color: #2b0c0b"><b><b>Android Game</b></b></p>
                            <p style="color: #2b0c0b"> As a former restaurant manager, I took the opportunity to create
                                an
                                android game,
                                utilizing
                                Java and Android Studio. Designed to entertain our visitors while they wait for their
                                meals,
                                this unique game puts players in control of a waitress. The objective is to skillfully
                                catch
                            ...
                            <p style="color: #2b0c0b"><b><b>Discord Bot</b></b></p>
                            <p style="color: #2b0c0b">In my very first project, I developed a memo/planner bot for
                                Discord
                                using Java. This bot
                                is
                            ...
                            <h3 id="cvh" style="color: #8d2a1b"><u><b>WORK EXPERIENCE</b></u></h3>
                            <p style="color: #2b0c0b"><b><b>PHP Developer</b></b></p>
                            <p style="color: #2b0c0b">Private Entrepreneurship · FreelancePrivate<br>
                                Feb 2022 - Present</p>
                            <p style="color: #2b0c0b">As a freelance PHP developer on online platforms , I have
                            ...
                            <p style="color: #2b0c0b"><b><b>Business Manager</b></b></p>
                            <p style="color: #2b0c0b">Mokka Cukka Brunch and Lounge<br>
                                2018 - 2022</p>
                            <p style="color: #2b0c0b">As a business manager, my responsibilities included creating and
                                managing financial
                                statements to ensure accuracy and compliance with regulatory requirements. I also
                                directed
                                and managed employee shift schedules, optimizing coverage and operational efficiency.
                                Additionally, I tracked stock levels and managed orders to ensure timely delivery and
                                enhance customer satisfaction.</p>

                            <p style="color: #2b0c0b"><b><b>Account Manager</b></b></p>
                            <p style="color: #2b0c0b">KÖZÖS POZITÍV ÉRDEK KFT./COMMON POSITIVE INTERESTS LTD./<br>
                                2013 - 2016</p>
                            <p style="color: #2b0c0b">As part of my role, I was responsible for managing the financial
                                database using MYSQL,
                                ensuring data integrity and accuracy.I actively engaged with funders, establishing and
                                maintaining strong communication channels to secure financial support.Additionally, I
        ...
        <div class=" section-title text-center">
            <p><a id="download-link" href="{{ url('/download-pdf') }}"
