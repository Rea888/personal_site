...
<head>
    ...
    <link rel="stylesheet" href="{{asset('https://static.viktoriarakhely.eu/assets/css/gameLandscape.css')}}">
</head>
<body>
...
<script src="{{asset('https://static.viktoriarakhely.eu/assets/js_mini/gameLandscape.min.js')}}"></script>
</body>
</html>
